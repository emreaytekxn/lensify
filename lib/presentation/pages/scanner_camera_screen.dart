...
class ScannerCameraScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ScannerCameraScreen> createState() =>
    ...
    try {
      ...
      if (_isIdCardMode) {
        if (_idCardFrontPath == null) {
          ...
          final combinedPath = await ImageProcessingService.combineIdCard(
              _idCardFrontPath!, photo.path);
    ...
    if (croppedFile != null) {
      ...
      if (_isBatchMode && widget.targetDocumentId != null) {
        ...
        await repo.addPageToDocument(DocumentPage(
          ...
          processedImagePath: croppedFile
              .path, // Assuming no filter in rapid batch mode for simplicity, or we can apply default
          ...
          Align(
            ...
            child: Container(
              padding: const EdgeInsets.only(
                  bottom: 40, left: 24, right: 24, top: 16),
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            shape: BoxShape.circle,
                            border: Border.all(
                                color: _isIdCardMode && _idCardFrontPath != null
                                    ? Colors.orange
                                    : Colors.white,
                                width: 4),
                          ),
