...
extension FolderModelQueryFilter
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterFilterCondition> colorEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterFilterCondition> colorLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterFilterCondition> colorBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterFilterCondition> isLockedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isLocked',
...
extension FolderModelQuerySortBy
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> sortByColor() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'color', Sort.asc);
    });
  }

  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> sortByColorDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> sortByIsLocked() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLocked', Sort.asc);
    });
  }

  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> sortByIsLockedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension FolderModelQuerySortThenBy
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> thenByColor() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'color', Sort.asc);
    });
  }

  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> thenByColorDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'color', Sort.desc);
    });
  }
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> thenByIsLocked() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLocked', Sort.asc);
    });
  }

  QueryBuilder<FolderModel, FolderModel, QAfterSortBy> thenByIsLockedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLocked', Sort.desc);
    });
  }
...
extension FolderModelQueryWhereDistinct
  ...
  QueryBuilder<FolderModel, FolderModel, QDistinct> distinctByColor() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FolderModel, FolderModel, QDistinct> distinctByIsLocked() {
    return QueryBuilder.apply(this, (query) {
...
extension FolderModelQueryProperty
  ...
  QueryBuilder<FolderModel, int, QQueryOperations> colorProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FolderModel, bool, QQueryOperations> isLockedProperty() {
    return QueryBuilder.apply(this, (query) {
